...
<title>Prueba — Dictamen AVBA</title>
<style>
...
<div class="card">
  ...
  <h1>Generador de Dictamen</h1>
  <p class="subtitle">Prueba de renderizado PDF — Hostinger</p>

  <hr class="divider">

  <div class="info-box">
    <p><strong>Plantilla:</strong> dictamen_preview.html</p>
    <p><strong>Motor PDF:</strong> mPDF (compatible Hostinger shared)</p>
    <p><strong>Páginas:</strong> 3 páginas / Letter 215×279 mm</p>
    <p><strong>DPI:</strong> 96</p>
  </div>

  <a class="btn btn-primary" href="generar_dictamen_web.php" target="_blank">
    ▶ Ver PDF en el navegador
  </a>

  <a class="btn btn-secondary" href="generar_dictamen_web.php?descarga=1">
    ⬇ Descargar PDF
  </a>
