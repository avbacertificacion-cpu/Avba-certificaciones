...
// Los datos de ejemplo sólo pueden entrar en la instalación de demostración.
// En el sistema real esta pantalla no siembra nada: las plantas de ejemplo
// mezcladas con las de verdad falsean los tableros y los reportes.
if (!esModoDemo()) {
    include __DIR__ . '/_solo-demo.php';
    exit;
}
